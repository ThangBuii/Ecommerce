 ...
 * @author thang
 */
public class ShoppingHistory extends DBContext{
    String orderid,pid, quantity, subtotal, uid, price, image, name;

    public ShoppingHistory(String orderid, String pid, String quantity, String subtotal, String uid, String price, String image, String name) {
    ...
    public ShoppingHistory(String pid, String quantity, String subtotal, String uid, String price, String image, String name) {
        this.pid = pid;
        this.quantity = quantity;
        this.subtotal = subtotal;
        this.uid = uid;
    ...
    public ShoppingHistory(String pid, String quantity, String subtotal, String price, String image, String name) {
        this.pid = pid;
        this.quantity = quantity;
        this.subtotal = subtotal;
        this.price = price;
    ...
    public void connect() {
        try {
            ...
            if (cnn != null) {
                System.out.println("Connect successfully to ShoppingHistory: " + pid);
            }
        } catch (Exception e) {
    ...
    public void addItems() {
        try {
            String strUpdate = "insert into ShoppingHistory "
                    + "values(?,?,?,?,?,?,?,?)";
            pstm = cnn.prepareStatement(strUpdate);
            pstm.setInt(1, Integer.parseInt(pid));
            ...
            pstm.setInt(8, Integer.parseInt(orderid));
    ...
    public ArrayList<ShoppingHistory> getListByOID(String oid) {
        ArrayList<ShoppingHistory> data = new ArrayList<ShoppingHistory>();
        try {
            String strSelect = "select * from ShoppingHistory "
                    + "where OrderID=? ";
            pstm = cnn.prepareStatement(strSelect);
            pstm.setInt(1, Integer.parseInt(oid));
            rs = pstm.executeQuery();
            ...
            while (rs.next()) {
                ...
                String image = rs.getString(6);
                String name = rs.getString(7);
                String orderid = String.valueOf(rs.getInt(8));

                ShoppingHistory s = new ShoppingHistory(orderid, pid, quantity, subtotal, uid, price, image, name);
                data.add(s);
            }
        } catch (Exception e) {
            System.out.println("getListByOID:" + e.getMessage());
        }
        return data;
    }
